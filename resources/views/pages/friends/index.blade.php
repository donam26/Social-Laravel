...
@section('content')
    <script type="text/javascript">
        ...
        function loadUserInfo(data) {
            ...
            form.find("#friend_id").val(data.id);
        }
    ...
    <div class="body flex-grow-1 px-3">
        <div class="container-lg">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form id="filter-form" action="{{ route('admin.friends') }}" method="GET">
                                <!-- name -->
                                <div class="mb-2 row">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <a class="btn btn-secondary btn-sm filter-form__cancel"
                                            href="{{ route('admin.friends') }}">Hủy</a>
                                    </div>
                                </div>
                            </form>
                        </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card mb-4">
                        <div class="card-header"><strong>Danh sách</strong><span class="small ms-1">bạn bè</span>
                                ...
                                <tbody>
                                    @foreach ($friends as $friend)
                                        <tr>
                                            ...
                                            <td>{{ $friend->name }}</td>
                                            <td>{{ $friend->name }}</td>
                                            <td>@include('components.friend-status', ['status' => $friend->status])</td>
                                            <td>
                                                <button class="btn btn-primary btn-sm" type="button"
                                                    data-orderitem-id="{{ $friend->id }}" data-coreui-toggle="modal"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="edit-user-form" action="POST">
                        @csrf
                        <input id="friend_id" type="text" hidden>
                        <!-- name  -->
                        <div class="mb-3 row">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-8">
                                <input id="title" class="form-control title" name="title"
                                    placeholder="Tiêu đề bạn bè..." value="" type="text">
                            </div>
                        </div>
