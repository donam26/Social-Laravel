            ...
            <div class="row">
                <div class="col-12">
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form id="filter-form" action="{{ route('admin.feels') }}" method="GET">
                                <!-- title -->
                                <div class="mb-2 row">
                                            ...
                                            <td>
                                                @if ($feel->image)
                                                    <img style="width: 110px"
                                                        src="{{ asset('/storage/images/' . $feel->image) }}" alt="products"
                                                        srcset="">
                                                @else
                                                    <span class="badge me-1 bg-light text-dark">Không có hình ảnh</span>
                                                @endif
                                            </td>
                                            <td>@include('components.feel-status', ['status' => $feel->status])</td>
                                            <td>
                                                <button class="btn btn-primary btn-sm" type="button"
                                                    data-orderitem-id="{{ $feel->id }}" data-coreui-toggle="modal"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="edit-user-form" action="POST">
                        @csrf
                        <input id="feel_id" type="text" hidden>
                        <!-- name  -->
                        <div class="mb-3 row">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-8">
                                <input id="title" class="form-control title" name="title"
                                    placeholder="Tiêu đề bài viết..." value="" type="text">
                            </div>
                        </div>
